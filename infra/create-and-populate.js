...
VALUES 
    (1, 'Rafael Silva', 'rfsilva022@gmail.com', '*******'),
    (2, 'Anderson Ferreira', 'andersonferreira@gmail.com', '********'),
    (3, 'João Vitor', 'joaoo@gmail.com', '********')
`
...
function criaTabelaTarefas() {
    db.run(TAREFAS_SCHEMA, (error)=> {
        if(error) console.log("Erro na tabela de Tarefas");
    });
}
